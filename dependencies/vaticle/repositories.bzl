...
def vaticle_typeql():
    git_repository(
        name = "vaticle_typeql",
        remote = "https://github.com/lolski/typeql",
        commit = "1dff58b460ea20d1c5232a005b7440f982d9388b", # sync-marker: do not remove this comment, this is used for sync-dependencies by @vaticle_typeql
    )
